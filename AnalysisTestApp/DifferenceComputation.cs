...
namespace AnalysisTestApp
{
    class DifferenceComputation
    {
        ...
        public static int[,] getManhattan(Bitmap bmp1, Bitmap bmp2, int[] positions)
        {
        ...
        public static int[,] getEuclidean(Bitmap bmp1, Bitmap bmp2, int[] positions)
        {
            int x0 = Math.Max(0, positions[0]);
            int x1 = Math.Min(bmp1.Width, bmp2.Width + positions[0]);
            int y0 = Math.Max(0, positions[1]);
        ...
        private static int[,] getGlobalCorrelation(Bitmap bmp1, Bitmap bmp2, int[] positions)
        {
